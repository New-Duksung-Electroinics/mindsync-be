...
import com.mindsync.mindsync.dto.response.ChatMessageResponse;
...
public class ChatMessageController {
    ...
    public void enterChatRoom(@Payload ChatMessageResponse message, @DestinationVariable String roomId) {
    ...
    public void sendMessage(@Payload ChatMessageResponse message, @DestinationVariable String roomId) {
